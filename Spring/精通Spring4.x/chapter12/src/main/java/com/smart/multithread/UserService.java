...
public class UserService extends BaseService {
    ...
    public static void main(String[] args) {
       ...
       jdbcTemplate.execute("INSERT INTO t_user(user_name,password,score,last_logon_time) VALUES('tom','123456',10," + System.currentTimeMillis() + ")");
        ...
        System.out.println("1before userService.logon method...");
        service.logon("tom");
        System.out.println("1after userService.logon method...");
    ...
    public void logon(String userName) {
        System.out.println("2before userService.updateLastLogonTime method...");
        updateLastLogonTime(userName);
        System.out.println("2after userService.updateLastLogonTime method...");
        //在同一个线程中调用scoreService#addScore,将运行同一个事物
        //scoreService.addScore(userName, 20);
        //在一个新线程中执行score.addScroe 将启动一个新的事物
    ...
    private class MyThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println("3before scoreService.addScor method...");
            scoreService.addScore(userName, toAdd);
            System.out.println("3after scoreService.addScor method...");
        }
    }
